...
C
      ...
      GROUP(20)='g20'
C
      OPEN(8,FILE='data/hyaqt.sml',STATUS='OLD')
      OPEN(9,FILE='data/vcont3.sml',STATUS='OLD')
      OPEN(10,FILE='data/head.sml',STATUS='OLD')
      OPEN(11,FILE='data/bot.sml',STATUS='OLD')
      OPEN(12,FILE='data/hycond.sml',STATUS='OLD')
      OPEN(13,FILE='data/top4.sml',STATUS='OLD')
C
      DO 1 K=1,NL
      DO 1 I=1,NR
...
C
      ...
      IF(IRQ.GT.1) THEN
      IRQM=IRQ-1
      FNAME= 'output/wells-r'//RQ(IRQM:IRQM)//'.'//GROUP(IG)
...
6     CONTINUE
      ...
      NWELL=0
      END IF
      FNAME= 'output/wells-r'//RQ(IRQ:IRQ)//'.'//GROUP(IG)
      OPEN(10,FILE=FNAME,STATUS='NEW',ERR=5000)
      FNAME= 'output/data-r'//RQ(IRQ:IRQ)//'.'//GROUP(IG)
      OPEN(15,FILE=FNAME)
C
...
1100  FORMAT(1X,'Row ',I2,' Column ',I2,'  Bedrock = ',F7.2,' feet') 
      ...
      END IF
60    CONTINUE
      OPEN(30,FILE='output/template.dcf')
      FNAME= 'output/dcf-r'//RQ(IRQ:IRQ)//'.'//GROUP(IG)
